...
<title>Editar Paciente | e-Fisioterapia</title>
<link rel="stylesheet"
...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
	...
	<div class="signup-form">
		<form action="updatePaciente">
			<h2>Editar Paciente</h2>
			<p>Prezado(a), forneça as informações corretas!</p>
			<hr>
			<div class="form-group">
				<div class="form-group">
					<label>ID</label><input readonly name="cod_paciente" type="text"
						class="form-control"
						value="<%out.print(request.getAttribute("cod_paciente"));%>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>Data de Nascimento</label> <input name="dt_nascimento"
				...
				<div class="form-group">
					<label>Profissão</label> <input name="profissao"
						class="form-control"
						value="<%out.print(request.getAttribute("profissao"));%>"></input>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label>Telefone</label> <input name="telefone" type="phone"
						class="form-control" value="<%out.print(request.getAttribute("telefone"));%>"></input>
				</div>
			</div>
			<div class="modal-footer">
			<a class="btn btn-info" href="paciente" role="button">Cancelar</a>
